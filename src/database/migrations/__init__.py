...
class DatabaseInitializer:
    ...
    def _get_total_memory(self) -> float:
        try:
            if platform.system() == "Linux":
                ...
                return mem.value / (1024 * 1024 * 1024)
        except Exception as e:
    ...
    def create_database_file(self) -> bool:
        ...
        try:
            ...
            # Handle both integer (1/0) and string ('on'/'off') responses
        ...
        try:
            ...
            for migration_file in migration_files:
                ...
                migration_registry[version] = {
                    ...
                    "sha256": checksum,
                    "md5": hashlib.md5(migration_file.read_bytes()).hexdigest(),
...
This directory contains database migration scripts for Cockatoo.
"""
...
'''
    ...
    def _check_migration_has_rollback(self, file_path: Path) -> bool:
        try:
            ...
            return "def rollback" in content or "class Rollback" in content
        except Exception:
            return False
    ...
    def perform_safety_checks(self) -> bool:
        ...
        # FIXED: Ensure data directory exists before creating lock files
...
def is_initialized(data_dir: str = "data") -> bool:
    ...
    try:
        ...
        has_migration_table = cursor.fetchone() is not None
        conn.close()
        return has_migration_table
    except Exception:
        return False
...
def get_initialization_status(data_dir: str = "data") -> Dict[str, Any]:
    ...
    status["initialized"] = (
        ...
        all(dir_info["exists"] for dir_info in status["directory_structure"].values())
    )
